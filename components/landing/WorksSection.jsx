...
const tabs = [
  { name: 'Show All', href: '#', current: false },
  { name: 'Architecture', href: '#', current: false },
  { name: 'Construction', href: '#', current: true },
  { name: 'Consulting', href: '#', current: false },
  { name: 'Electrical', href: '#', current: false },
  { name: 'Metal Roofing', href: '#', current: false },
...
const WorksSection = () => {
  ...
  return (
    <div className='relative'>
      ...
      <div className="hidden sm:block pb-16">
